...
SELECT functions_are( 'hn_ranker', ARRAY['build_stories_fetch','build_stories_last','build_stories_ranks','do_all','do_run','do_run_story','max_id','wget_item_json','wget_items','wget_rankings'] );
